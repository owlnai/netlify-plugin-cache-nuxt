  ...
  async onPreBuild({ constants, utils }) {
    ...
    if (process.cwd() === constants.PUBLISH_DIR) {
      utils.build.failBuild(
        `Nuxt sites must publish the public directory, but your site’s publish directory is set to “${constants.PUBLISH_DIR}”. Please set your publish directory to your Nuxt site’s public directory.`,
      );
    }
    ...
    if (await utils.cache.restore(cacheDirs)) {
      console.log('Found a Nuxt cache. We’re about to go FAST. ⚡️');
    } else {
